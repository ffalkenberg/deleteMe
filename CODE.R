...
#Load data into R
orders <- read.csv("~/OneDrive - ESMT Berlin/ESMT/DSA - Data Science for Analytics/Assignment 1/orders.csv")
users <- read.csv("~/OneDrive - ESMT Berlin/ESMT/DSA - Data Science for Analytics/Assignment 1/users.csv")
...
ggplot(orders_full1, aes(x = year_of_birth, y = ..density..)) +
